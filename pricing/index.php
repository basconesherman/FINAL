	...
	<body>
		<div class="container">
			...
			<div class="content-grid">
				...
				<div id="tabs">
					<ul>
						<a href="index.php"><li><img src="images/pricing-1-active.png"></li></a>
						...
						<li id="total"><center><p id="totalValue">$0.00</p></center></li></a>
					</ul>
				</div>
			</div>
			<div id="paper-box">
				<form id="pricing-tab-" action="paper-process.php" method="post">
					...
					<div class="content-grid">
						...
						<script type="text/javascript">
							...
							var $RButtons1 = $('input[name=paper]');
							var $RButtons2 = $('input[name=radios]');
							var $RButtons3 = $('input[name=radios2]');
							var opt = "<?php echo $_COOKIE['paper_opt']; ?>";
							var pf = "<?php echo $_COOKIE['front']; ?>";
							var pb = "<?php echo $_COOKIE['back']; ?>";
							
							jQuery.each($RButtons1, function () {
								var value = $(this).attr('value');
								if(opt == value){
									$(this).attr('checked', 'checked');
								}
							});
							jQuery.each($RButtons2, function () {
								var value = $(this).attr('value');
								if(pf == value){
									$(this).attr('checked', 'checked');
								}
							});
							jQuery.each($RButtons3, function () {
								var value = $(this).attr('value');
								if(pb == value){
									$(this).attr('checked', 'checked');
								}
